...
public:
	 ...
	 */
	uint8_t draw_string(uint8_t x, uint8_t y, etl::string<SSD1306_MAX_SIZE> str,
			ssd1306_color_t foreground, ssd1306_color_t background);
	/**
	 ...
	 */
	uint8_t measure_string(etl::string<SSD1306_MAX_SIZE> str);
	/**
	...
	void clean_position(uint8_t x, uint8_t lines);
};
